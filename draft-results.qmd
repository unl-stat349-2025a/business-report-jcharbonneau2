...
Now we have our shark plot of the locations of the stations. Let's combine the two data sets to see where the sharks have been seen in reference to the waterspout locations. We'll use a 50 km threshold for the distances between waterspouts and shark stations.
